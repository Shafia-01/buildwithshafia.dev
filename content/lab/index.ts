...
export const labItems: LabItem[] = [
  {
    ...
    architecture: {
      ...
      steps: [
        "Chron tasks scan 20 RSS news endpoints every 60 seconds.",
        "Payload filter parses XML articles and handles duplicate stories using hashes.",
        "Text chunks are analyzed by three sentiment models (VADER, FinBERT, and Custom classifier).",
    ...
    engineeringWork: [
      ...
      "Setup a deduplication index storing story hashes in Redis to skip repetitive content."
    ],
    results: [
  ...
  },
  {
    ...
    engineeringWork: [
      ...
      "Evaluated target performance across noise profiles, accents, and phrase complexities."
    ],
    results: [
      "Compared performance metrics of XTTS-v2 vs VALL-E-X architectures.",
      "Executed 15 speaker configuration test cycles.",
      "Averages a Speaker Embedding Cosine Similarity score of 0.965.",
  ...
  },
  {
    ...
    results: [
      ...
      "Setup 6 strict query parameter validation checks.",
